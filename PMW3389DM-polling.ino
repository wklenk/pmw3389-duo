// Source: https://github.com/mrjohnk/PMW3389DM (Copied 2023-01-31)
// See also https://www.tindie.com/products/jkicklighter/pmw3389-motion-sensor/
...
void UpdatePointer(void){
  if(initComplete==9){
    ...
    /* Commented (WK): Uses just 8 bit of deltas for X and Y direction
...
void loop() {
  ...
  */
  ...
  // 2023-01-31 Adapted to fix sample interval (WK)
  if(currTime > pollTimer){
    UpdatePointer();

    // For every movement for 1 inch (2.54cm),
    // the coordinate changes plus or minus 16000.
